...
data.table. Unfortunately the interval class create by ivs is built upon on the
[record type from vctrs](https://vctrs.r-lib.org/reference/new_rcrd.html) and
these are not supported in data.table:
